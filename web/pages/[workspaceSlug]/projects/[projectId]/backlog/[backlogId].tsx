...
const BacklogDetailsPage: NextPageWithLayout = () => {
  // router
      ...
      {error ? (
        <EmptyState
          ...
          primaryButton={{
            ...
            onClick: () => router.push(`/${workspaceSlug}/projects/${projectId}/backlogs`),
          }}
        />
...
BacklogDetailsPage.getLayout = function getLayout(page: ReactElement) {
  return (
